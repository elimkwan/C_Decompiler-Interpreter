The author: 36308 The date the program was written: 09/03/2017Description of what the program does: The program shows the version, instruction mnemonic corresponding to different opcode and machine codes of a text file.It can also shows the hexadecimal representation of a text file and decompile a machine code file to assembly code.Instructions for compiling the program: type ‘make’ in the directoryExpected Output:
$./asmdump 
Usage:
./asmdump.exe —-version
...
asmdump created on 03/02/2017
./asmdump.exe —-opcode OPCODE function added on 17/02/2017
./asmdump.exe —-hexdump [FILE]function added on 03/03/2017
./asmdump.exe FILE function added on 08/03/2017
